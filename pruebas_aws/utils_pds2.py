...
from scipy.stats import binom, beta, expon, mvn, shapiro, ttest_ind, bernoulli, binom_test,     pearsonr
import cvxpy as cp
...
def deflacion(d, cor=False, MAX=150):
    """
